@objc(BluetoothLite)
class BluetoothLite: RCTEventEmitter {
    ...
    @objc
    func getAdapterState(_ resolve: @escaping RCTPromiseResolveBlock,
                   rejecter reject: RCTPromiseRejectBlock) {
        resolve([Strings.adapterState: bluetoothCentral.state.rawValue] as NSDictionary)
    }
    ...
    override func supportedEvents() -> [String]! {
        return ["CONNECTION_STATE", "ADAPTER_STATE", "DEVICE_FOUND", "NOTIFICATION"]
    }
